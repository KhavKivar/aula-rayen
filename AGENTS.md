...
- El frontend usa `VITE_PUBLIC_API_URL` para llamadas directas a la API (`https://aula-rayen.vasvani.shop/api` en prod, `http://localhost:3000` en dev) vía `src/lib/auth-client.ts` directo, sin proxy.
